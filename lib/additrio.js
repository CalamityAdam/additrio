 ...
 *  @since 1.0.0
 */
function additrio(num1, num2, num3 = 0) {
    // Check if arguments are numbers
    [num1, num2, num3].forEach((num, index) => {
        if (typeof num !== 'number') {
            throw new TypeError(`Argument ${index + 1} must be a number, received ${typeof num}`);
        }
    });
    // Perform addition
    return num1 + num2 + num3;
}
exports.additrio = additrio;
